...
INSERT INTO city (id, name, country_code, district, population) VALUES (5, 'Amsterdam', 'ALB', 'Noord-Holland', 731200);
...
INSERT INTO country (code, name, continent, region, surfacearea, indepyear, population, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital, code2) VALUES ('ALB', 'Albania', 'Europe', 'Southern Europe', 28748, 1912, 3401200, 71.6, 3205.00, 2500.00, 'Shqip«ria', 'Republic', 'Rexhep Mejdani', 34, 'AL');
